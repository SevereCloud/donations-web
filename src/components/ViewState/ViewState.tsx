    ...
    <Div>
      {progress < 100 && (
        <>
          <div className="progress-label">
            ...
            {progress > 70 && (
              <Text weight="semibold" className="progress-inner-text">
          ...
          <div className="progress">
            <div className="bar" style={{ width: `${progress}%` }}>
              {progress > 30 && (
                <Text weight="semibold" className="bar-inner-text">
            ...
            <div className="progress-inner-text-container">
              {progress <= 30 && (
                <Text weight="semibold" className="progress-inner-text-bar">
                  {formattedNumber(donationProgress)}
                </Text>
              )}
            </div>
      ...
      {progress >= 100 && (
        <>
          ...
          <div className="progress">
            <div className="bar-finish" style={{ width: `${progress}%` }}>
              <Text weight="semibold" className="bar-inner-text">
...
const ViewState: FunctionComponent = () => {
  ...
  useEffect(() => {
    if (donationProgress < donationNeed) {
      setTimeout(
        () =>
          setDonationProgress(
            (prevProgress) => prevProgress + donationNeed * 0.01,
          ),
        600,
      );
    } else {
  ...
  return (
    <Group separator="hide" header={<Header mode="secondary">states</Header>}>
      <CardGrid>
